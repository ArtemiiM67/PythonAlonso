...
class Cart:
  ...
  def addItems(self, theName, thePrice):
      self.total += thePrice
      self.itemList.append(theName)

  def totalGiftCard(self, theCard):
      self.total -= theCard
      return self.total
...
class Player:
   ...
   def addPoints(self, thePoints):
       self.score += thePoints
       if self.score > 100:
           return self.score, "YOU WIN"
       return self.score

   def gainPowerUp(self, thePower):
       self.powerUps.append(thePower)
